...
const JobApplicationForm = () => {
  ...
  return (
  <div className="dark bg-[#0e1420] text-white min-h-screen">
   <div className="flex justify-center mb-8">
  <Link
    to="/careers"
    className="inline-flex items-center gap-2 px-5 py-2 text-base font-medium rounded-md bg-[#1E293B] text-white hover:bg-blue-600 transition-colors duration-200 shadow-md"
  >
    ← Back to Careers
  </Link>
</div>
